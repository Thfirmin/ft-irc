...
SRC	= $(addprefix SRC/, main.cpp Authenti.cpp Channel.cpp Client.cpp Server.cpp \
	  					INVITE.cpp JOIN.cpp KICK.cpp MODE.cpp \
						PART.cpp PRIVMSG.cpp QUIT.cpp TOPIC.cpp)
...
.PHONY: all clean fclean re #setup remove_sudoers val
